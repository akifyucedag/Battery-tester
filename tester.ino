...
#define SCREEN_WIDTH 128 // oled ekranın boyutları tanımlanıyor.
...
const float Low_BAT_level = 2.5;// bu değer kullanılan pilin minimium gerilimine göre değiştirilecek
...
int ADC_Value = 0;
float Vcc = 4.96 ; // arduinonun besleme voltajı 
float BAT_Voltage = 0;
float sample =0;
